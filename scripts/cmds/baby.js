    ...
    if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
      ...
      const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments });  return res.data.message; } catch {  return "error janu🥹";
       ...
       const randomMessage = [
          ...
          "Sorbonash 🙆",
          "❥⃝🙈দি্ঁলে্ঁ লা্ঁগে্ঁ টা্ঁন্ঁ ❥⃝ 🫵   🪶 তুমি হ্ঁবে্ঁ নাকি আ্ঁমা্ঁর্ঁ  জা্ঁন্ঁ😍❥❥⃝ʚ🫶☺️🙈",
          ...
          "𝗜 𝗵𝗮𝘁𝗲 𝘆𝗼𝘂__😏😏",
          "গোসল করে আসো যাও😑😩",
          "♡︎⎯͢⎯⃝🩷🌻 অসুন্দর হতে পারি, অহংকারী নই..!🌸💚⎯⃝",
          "Sweetheart Bolo 😹",
          "𝐈 𝐋𝐨𝐯𝐞 𝐘𝐨𝐮🥺ইগনোর করিস না,,তুই পড়ছোস মানে তোরেই বলছি রিপ্লাইটা দিয়া যা.🌸😌",
          "বলেন ম্যাডাম__😌",
          "আমি অন্যের জিনিসের সাথে কথা বলি না__😏ওকে",
          "রাতে ঘুম আসেনা বলে অনলাইনে থাকি কিন্তু সবাই ভাবে আমি প্রেম কইরা উল্টাইয়া পালাইতাসি।",
          ...
          "Google এ সার্চ করলাম রিলেশনে যেতে চাই 😒😒Google বল্লো Welcome to বাঁশ বাগান🙂🙂🙂",
